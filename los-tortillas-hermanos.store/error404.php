...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen and (max-width: 1000px)" href="css/petiteError404.css">
	<link rel="icon" type="image/png" href="img/logoLosTortillas.png">
	<title>LosTortillasHermanos - Error404</title>
</head>
<body>
	<div id="ConteinerBox">
		...
		<div id="MainBox">
			...
			<div id="errorTextBox">
				<p class="errorText">
					<a class="muiSecreto" href="meth.php">go</a>&nbspaway this is an error
				</p>
			</div>
